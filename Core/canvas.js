...
function resizeCanvas(){
  ...
  var sclX = canvas.width/canvasWidth;
  var sclY = canvas.height/canvasHeight;
  ...
  canvasOffsetX = (canvas.width -(canvasWidth*canvasSclX))/2;
  canvasOffsetY = (canvas.height -(canvasHeight*canvasSclY))/2;
